...
| `user-folder.md` | Everything under `/SCRIPTS/TOOLS/rfsuite.user/`: preferences, per-model preferences, user themes, the flight log files, session logs; what survives an update. | README, one sentence | to write |
