...
Theme.boxes = {
  ...
  { col = 1, row = 10, colspan = 1, rowspan = 3, type = "text", subtype = "telemetry", source = "rate_profile", title = "@i18n(widgets.dashboard.rates):upper()@", titlepos = "bottom", transform = "floor", titlecolor = COLOR_THEME_PRIMARY2, textcolor = WHITE, bgcolor = BLACK, font = AercCommon.compactStatsFont, autosize_chars = 2, autosize_font = SMLSIZE },
  { col = 2, row = 10, colspan = 1, rowspan = 3, type = "text", subtype = "telemetry", source = "pid_profile", title = "@i18n(widgets.dashboard.profile):upper()@", titlepos = "bottom", transform = "floor", titlecolor = COLOR_THEME_PRIMARY2, textcolor = WHITE, bgcolor = BLACK, font = AercCommon.compactStatsFont, autosize_chars = 2, autosize_font = SMLSIZE },
  { col = 3, row = 10, colspan = 1, rowspan = 3, type = "time", subtype = "count", title = "@i18n(widgets.dashboard.flights):upper()@", titlepos = "bottom", titlecolor = COLOR_THEME_PRIMARY2, textcolor = WHITE, bgcolor = BLACK, font = AercCommon.compactStatsFont, autosize_chars = 3, autosize_font = SMLSIZE },
