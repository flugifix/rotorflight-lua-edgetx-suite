...
Theme.boxes = {
  ...
  { col = 7, row = 7, colspan = 2, rowspan = 2, type = "text", subtype = "telemetry", source = "link", unit = "dB", autosize_chars = 3, title = "@i18n(widgets.dashboard.lq):upper()@", titlepos = "bottom", transform = "floor", titlecolor = COLOR_THEME_DISABLED, textcolor = WHITE, bgcolor = BLACK, font_lowres = SMLSIZE, title_max_chars_lowres = 4, max_chars_lowres = 5 },
  ...
  { col = 9, row = 1, colspan = 6, rowspan = 6, type = "gauge", subtype = "arc", source = "throttle_percent", unit = "%", decimals = 0, min = 0, max = 100, title = "@i18n(widgets.dashboard.throttle):upper()@", titlepos = "bottom", titlecolor = COLOR_THEME_DISABLED, textcolor = WHITE, bgcolor = BLACK, fillbgcolor = COLOR_THEME_SECONDARY2, value_offset_y = -4 },
  { col = 15, row = 1, colspan = 6, rowspan = 6, type = "gauge", subtype = "arc", source = "bec_voltage", unit = "V", decimals = 2, min = voltageMin, max = voltageMax, title = "@i18n(widgets.dashboard.voltage):upper()@", titlepos = "bottom", titlecolor = COLOR_THEME_DISABLED, textcolor = WHITE, bgcolor = BLACK, fillbgcolor = COLOR_THEME_SECONDARY2, value_offset_y = -4 },
