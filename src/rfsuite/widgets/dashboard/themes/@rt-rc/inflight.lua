...
Theme.boxes = {
  { col = 1, row = 1, colspan = 4, rowspan = 12, type = "gauge", subtype = "arc", source = "voltage", min = voltageMin, max = voltageMax, title = "@i18n(widgets.dashboard.voltage):upper()@", titlepos = "bottom", titlecolor = COLOR_THEME_DISABLED, textcolor = WHITE, bgcolor = BLACK, fillbgcolor = COLOR_THEME_SECONDARY2 },
  { col = 5, row = 1, colspan = 4, rowspan = 12, type = "gauge", subtype = "arc", source = "smartfuel", unit = "%", decimals = 0, min = 0, max = 100, title = "@i18n(widgets.dashboard.battery):upper()@", titlepos = "bottom", titlecolor = COLOR_THEME_DISABLED, textcolor = WHITE, bgcolor = BLACK, fillbgcolor = COLOR_THEME_SECONDARY2 },
