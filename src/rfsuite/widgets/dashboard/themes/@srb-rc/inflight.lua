...
Theme.boxes = {
  ...
  { col = 8, row = 1, colspan = 3, rowspan = 3, type = "text", subtype = "telemetry", source = "link", title = "@i18n(widgets.dashboard.lq):upper()@", titlepos = "top", unit = "dB", transform = "floor", titlefont = SMLSIZE, font = DBLSIZE, textcolor = WHITE, titlecolor = WHITE, bgcolor = BLACK },
