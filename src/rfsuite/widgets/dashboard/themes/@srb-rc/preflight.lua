...
Theme.boxes = {
  ...
  { col = 1, row = 1, colspan = 4, rowspan = 3, type = "text", subtype = "telemetry", source = "model_name", title = "CRAFT NAME", titlepos = "top", titlealign = CENTER, titlefont = SMLSIZE, font = DBLSIZE, textcolor = "orange", titlecolor = WHITE, bgcolor = BLACK },
  ...
  { col = 8, row = 1, colspan = 3, rowspan = 3, type = "text", subtype = "telemetry", source = "link", title = "LQ", titlepos = "top", unit = "%", transform = "floor", titlefont = SMLSIZE, font = DBLSIZE, textcolor = WHITE, titlecolor = WHITE, bgcolor = BLACK },
