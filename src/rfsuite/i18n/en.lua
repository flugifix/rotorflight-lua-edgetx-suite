  ...
  app = {
    ...
    pages = {
      ...
      settings_general = {
        ...
        help_message = "Configure safety prompts and developer visibility in general settings.",
        saved_title = "Saved",
      ...
      setup_wizard = {
        ...
        intro_p3 = "This part covers the radio and the basics on the board. The drivetrain, the servos and the mechanics are separate procedures.",
        ...
        channel_rudder = "Yaw",
        pick_arm = "Arms at",
        pick_throttle = "Motor released at",
        pick_governor = "Governor via",
        ...
        note_gov_later = "The governor switch is settled now. What its positions produce is the drivetrain section's, and until then the motor is off in every position.",
        pick_rescue = "Rescue at",
        marker_ok = "ok",
        marker_short = "short",
        marker_move = "move it",
        ...
        setup_note = "Will be set up. \"Leave alone\" keeps this channel unchanged.",
        hint_arm = "A two-position switch is the better choice here: armed or not, with no middle position.",
        ...
        rxmap_intro = "The board has to be told which channel carries which function. This layout is the ELRS order, and every step after this one depends on it.",
        ...
        marker_off = "off",
        marker_on = "on",
        verify_intro = "Values from the flight controller. On / off is what it would do at the switch position you are holding now.",
