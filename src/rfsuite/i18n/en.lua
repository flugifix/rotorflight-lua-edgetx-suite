  ...
  app = {
    ...
    pages = {
      ...
      setup_wizard = {
        ...
        pick_governor = "Switch position for motor off",
        ...
        gov_middle = "The motor cannot be off in the middle position. Pick an end position.",
        hold_others_off = "In every other position the motor is off.",
