  ...
  app = {
    ...
    pages = {
      ...
      setup_wizard = {
        ...
        link_intro = "The board does not measure the link, it is told what it is. Where the two disagree, telemetry is either starved or held back.",
        link_status = "Probe",
        link_probe = "Read",
        ...
        link_note = "Set module writes the transmitter to what the board expects. Set board writes the board to what the transmitter runs.",
        pick_empty = "-",
