return {
  app = {
    ...
    pages = {
      ...
      settings_dashboard_inflight = {
        ...
        pulse_ms = "Step length (ms)",
        trims = "Drive rows from the trims",
        trims_unreadable = "This radio did not report its trims; the default order is used.",
        trim_off = "Off",
        trim_1 = "Rudder",
        trim_2 = "Elevator",
        trim_3 = "Throttle",
        ...
        help_message = "Choose the interlock switch, the channels, variables and trims it uses, and a spare PID profile as the undo.",
        check_no_free_gvar = "Fewer than two free variables on this model",
        ...
        fc_other_switch = "In use by a switch on another channel:",
        fc_other_switch_note = "Those switches stop adjusting anything.",
        fc_kept = "Left alone:",
        fc_reminder = "The values only come back to the radio with telemetry sensor 99 selected and CRSF custom telemetry on.",
        fc_board_matches = "The flight controller already carries this set.",
  ...
  widgets = {
    dashboard = {
      ...
      inflight_profile = "PID profile",
      inflight_live = "LIVE",
      inflight_ground = "GROUND",
      inflight_bank = "bank",
      inflight_row = "row",
      inflight_trim = "trim",
      inflight_hdr_set = "set:",
      inflight_hdr_standard = "standard",
      inflight_hdr_custom = "custom",
      ...
      inflight_prime_never = "Not primed",
      inflight_prime_running = "Priming",
      inflight_prime_done = "Primed",
