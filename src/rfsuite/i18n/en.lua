  ...
  app = {
    ...
    pages = {
      ...
      setup_controls_inflight = {
        ...
        step = "Step size",
        step_note = "Written into every slot, so a changed step needs the flight controller set up again.",
        ...
        help_step = "The step is part of every slot, so a changed step needs the flight controller set up again before it takes effect.",
