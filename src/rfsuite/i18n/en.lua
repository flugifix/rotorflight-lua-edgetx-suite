  ...
  app = {
    ...
    pages = {
      ...
      setup_wizard = {
        ...
        pick_throttle = "Switch position for motor released",
        pick_governor = "Switch for the governor",
        ...
        note_ch_rescue = "At this switch position the flight controller triggers rescue. In every other position it is off.",
        note_ch_throttle = "Choose which switch stops the motor and which switch drives the governor.",
        note_ch_arm = "At this switch position the flight controller is armed.",
        marker_derived = "read",
