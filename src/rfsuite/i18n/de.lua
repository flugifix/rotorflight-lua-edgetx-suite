  ...
  app = {
    ...
    pages = {
      ...
      setup_wizard = {
        ...
        pick_governor = "Schalterstellung für Motor aus",
        ...
        gov_middle = "In der Mittelstellung kann der Motor nicht aus sein. Wähle eine Endstellung.",
        hold_others_off = "In jeder anderen Stellung ist der Motor aus.",
