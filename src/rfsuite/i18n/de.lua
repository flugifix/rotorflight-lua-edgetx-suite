  ...
  app = {
    ...
    pages = {
      ...
      setup_wizard = {
        ...
        link_intro = "Der Flugregler misst die Funkstrecke nicht, ihm wird gesagt, wie sie läuft. Wo beide nicht übereinstimmen, hungert die Telemetrie oder sie bleibt ungenutzt.",
        link_status = "Abfrage",
        link_probe = "Lesen",
        ...
        link_note = "Modul setzen schreibt den Sender auf das, was der Flugregler erwartet. Regler setzen schreibt den Flugregler auf das, was der Sender fährt.",
        pick_empty = "-",
