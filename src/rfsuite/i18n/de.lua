return {
  app = {
    ...
    pages = {
      ...
      settings_dashboard_inflight = {
        ...
        section_wiring = "Kanaele und Variablen",
        section_trims = "Reihen und Trimmungen",
        section_undo = "Rueckgaengig",
        enabled = "Aktiv",
        switch = "Freigabeschalter",
        no_model = "Flugcontroller verbinden: diese Einstellungen gehoeren zum Modell.",
        ...
        pulse_ms = "Schrittlaenge (ms)",
        trims = "Reihen ueber die Trimmungen bedienen",
        trims_unreadable = "Dieses Funkgeraet hat seine Trimmungen nicht gemeldet; es gilt die Standardreihenfolge.",
        trim_off = "Aus",
        trim_1 = "Heck",
        trim_2 = "Nick",
        trim_3 = "Gas",
        ...
        row_5 = "Reihe 5",
        row_6 = "Reihe 6",
        undo_note = "Der Flugcontroller speichert eine Aenderung kurz nach dem Disarm selbst; die Sicherung muss vorher bestehen.",
        backup_profile = "PID-Profil fuer die Sicherung",
        check_ok = "Setup in Ordnung",
        check_unchecked = "Setup nicht geprueft",
        ...
        bank_trim = "Trimmung fuer die Bank",
        bank_trim_note = "Mit einer Bank-Trimmung bleibt die Wechsel-Trimmung in der Bank; ohne sie laeuft sie durch den ganzen Satz.",
        adj_trim = "Trimmung zum Verstellen",
        check_claim = "Wechseln und Verstellen brauchen zwei verschiedene Trimmungen",
        help_message = "Waehle den Freigabeschalter, die Kanaele, Variablen und Trimmungen dazu und ein freies PID-Profil als Sicherung.",
        check_no_free_gvar = "Weniger als zwei freie Variablen an diesem Modell",
        ...
        plan_add = "Ergaenzen auf",
        plan_gvar = "Setzen",
        plan_trims = "Trimmungen aus in Flugmodus",
        plan_no_gvar = "Zuerst beide Variablen waehlen.",
        plan_same_gvar = "Die beiden Variablen muessen verschieden sein.",
        plan_same_channel = "Die beiden Kanaele muessen verschieden sein.",
        ...
        plan_cancelled = "Es wurde nichts geaendert",
        ...
        set_mode_standard_note = "Sechs Baenke mit je sechs Parametern, vorab bekannt. Der Flugregler wird zum Vergleich gelesen.",
        ...
        fc_verifying = "Zurueckgelesen",
        fc_write_slots = "Geschriebene Adjustment-Plaetze:",
        fc_overwritten = "Davon bereits belegt:",
        fc_overwritten_note = "Plaetze mit einer anderen Funktion werden ueberschrieben, egal zu welchem Schalter sie gehoeren.",
        fc_ids_only = "Gelesen wurde nur die Funktion jedes Platzes. Welchen Kanal er beobachtet, wird nach dem Schreiben geprueft.",
        fc_do_not_leave = "Seite nicht verlassen",
        fc_kept = "Unveraendert:",
        fc_reminder = "Die Werte kommen nur zurueck, wenn Telemetrie-Sensor 99 gewaehlt und CRSF Custom Telemetry aktiv ist.",
        fc_board_functions_match = "Jeder Platz dieser Belegung traegt bereits die richtige Funktion.",
        fc_board_empty = "Der Flugregler traegt nichts aus dieser Belegung.",
        fc_board_differs = "Abweichende Plaetze:",
        fc_board_unknown = "Der Flugregler wurde nicht verglichen.",
        fc_done = "Flugregler eingerichtet",
        fc_verify_differs = "Geschrieben, aber das Zurueckgelesene stimmt nicht",
        ...
        fc_channel = "Kein Empfaengerkanal des Flugreglers erreicht diesen Kanal.",
        help_setup_fc = "Schreibt die Standard-Belegung in die Adjustment-Plaetze, zeigt vorher was entfaellt. Nur bei Standard-Belegung.",
        saved_title = "Gespeichert",
  ...
  widgets = {
    dashboard = {
      ...
      inflight_profile = "PID-Profil",
      inflight_live = "LIVE",
      inflight_ground = "BODEN",
      inflight_bank = "Bank",
      inflight_row = "Reihe",
      inflight_trim = "Trimmung",
      inflight_hdr_set = "Satz:",
      inflight_hdr_standard = "Standard",
      inflight_hdr_custom = "eigener",
      ...
      inflight_prime_never = "Nicht ausgelesen",
      inflight_prime_running = "Lese aus",
      inflight_prime_done = "Ausgelesen",
      ...
      inflight_refuse_unset = "Sicherungsprofil in den Einstellungen waehlen",
      inflight_refuse_same = "Das Sicherungsprofil ist das geflogene: ein anderes waehlen",
