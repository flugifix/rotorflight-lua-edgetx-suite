return {
  app = {
    ...
    modules = {
      ...
      rates_advanced = { name = "Rates (Erweitert)" },
    ...
    pages = {
      flight_tuning_governor = {
        ...
        help_p6 = "Heck-Drehm.-Assist.: Fuer motorisierte Hecks. Gain und Limit der Drehzahlerhoehung bei Nutzung des Hauptrotordrehmoments zur Gierunterstuetzung.",
        loading_title = "Laden",
