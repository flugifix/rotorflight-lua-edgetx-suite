  ...
  app = {
    ...
    pages = {
      ...
      setup_controls_inflight = {
        ...
        step = "Schrittweite",
        step_note = "Wird in jeden Platz geschrieben; eine geänderte Schrittweite verlangt ein erneutes Einrichten.",
        ...
        help_step = "Die Schrittweite steht in jedem Platz; nach einer Änderung muss der Flugregler neu eingerichtet werden.",
