  ...
  app = {
    ...
    pages = {
      ...
      setup_wizard = {
        ...
        intro_p3 = "Dieser Teil deckt den Funk und die Grundlagen auf dem Board ab. Antrieb, Servos und Mechanik sind eigene Vorgänge.",
        ...
        pick_arm = "Schärft bei",
        pick_throttle = "Motor freigegeben bei",
        pick_governor = "Governor über",
        ...
        note_gov_later = "Der Governor-Schalter wird jetzt festgelegt. Die Werte seiner Stellungen setzt der Antriebs-Teil - bis dahin bleibt der Motor in jeder Stellung aus.",
        pick_rescue = "Rettung bei",
        marker_ok = "ok",
        marker_short = "kurz",
        marker_move = "bewegen",
        ...
        setup_note = "Wird eingerichtet. \"So lassen\" lässt den Kanal unverändert.",
        hint_arm = "Ein Zweistellungsschalter ist hier die bessere Wahl: scharf oder nicht, ohne Mittelstellung.",
        ...
        rxmap_intro = "Dem Flugregler muss gesagt werden, welcher Kanal welche Funktion traegt. Diese Belegung ist die ELRS-Reihenfolge, und jeder Schritt danach haengt daran.",
        ...
        marker_off = "aus",
        marker_on = "an",
        verify_intro = "Werte vom Flugregler. An / aus ist, was er bei der jetzigen Schalterstellung taete.",
        help_link = "Der Flugregler misst die Funkstrecke nicht - ihm wird gesagt, wie sie laeuft. Aus diesem Paar rechnet er einen Takt fuer jeden Telemetrie-Frame, den er absetzt. Steht dort mehr, als die Strecke traegt, plant er mehr ein als abfliesst: Rueckstau, verworfene Frames, alte statt fehlender Werte. Steht dort weniger, bleibt Bandbreite ungenutzt. Beides liest sich als hakende Telemetrie, und ein Fehler ist es nirgends. Geprueft hat das bisher keine Seite. Paketrate und Telemetrierate lassen sich hier direkt waehlen; die Listen sind die des Moduls, nicht unsere. Modul setzen schreibt den Sender, Regler setzen den Flugregler.",
        verify_aux = "-> AUX%d",
