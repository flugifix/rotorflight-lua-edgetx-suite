  ...
  app = {
    ...
    pages = {
      ...
      setup_wizard = {
        ...
        pick_throttle = "Schalterstellung für Motorfreigabe",
        pick_governor = "Schalter für den Governor",
        ...
        note_ch_rescue = "Bei dieser Schalterstellung löst der Flugregler die Rettung aus. In jeder anderen Stellung ist sie aus.",
        note_ch_throttle = "Lege fest, welcher Schalter den Motor abschaltet und welcher Schalter den Governor steuern soll.",
        note_ch_arm = "Bei dieser Schalterstellung wird der Flugregler scharf geschaltet.",
        ...
        marker_off = "aus",
        marker_on = "an",
        verify_intro = "Werte vom Flugregler. An / aus ist, was er bei der jetzigen Schalterstellung täte.",
