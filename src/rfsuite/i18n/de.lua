  ...
  app = {
    ...
    pages = {
      ...
      settings_dashboard_inflight = {
        ...
        fc_other_switch = "Belegt von einem Schalter auf einem anderen Kanal:",
        fc_other_switch_note = "Diese Schalter verstellen danach nichts mehr.",
        ...
        fc_board_matches = "Der Flugregler traegt diese Belegung bereits.",
