  ...
  app = {
    ...
    pages = {
      flight_tuning_governor = {
        ...
        full_headspeed = "Max. Kopfdrehzahl",
        min_throttle = "Min. Gas",
        max_throttle = "Max. Gas",
        gain = "Master-Gain",
        gains = "Gains",
        precomp = "Vorsteuerung",
        tail_torque_assist = "Heck-Drehmoment-Assist.",
        p = "P",
        i = "I",
        d = "D",
        f = "FF",
        ...
        help_p4 = "Vorsteuerung: Governor-Vorsteuerung fuer Gier-, Zyklisch- und Kollektiv-Eingaben.",
        help_p5 = "Max. Gas: Maximaler Gas-Prozentsatz, den der Governor verwenden darf.",
        help_p6 = "Heck-Drehmoment-Assist.: Fuer motorisierte Hecks. Gain und Limit der Drehzahlerhoehung bei Nutzung des Hauptrotordrehmoments zur Gierunterstuetzung.",
        loading_title = "Laden",
        ...
        profile_mismatch = "Bank ueber Schalter geaendert. Bitte neu laden.",
        profile_changed = "Bank geaendert",
