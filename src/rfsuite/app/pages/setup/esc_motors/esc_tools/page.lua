  ...
  for i = 1, #cards do
    ...
    local function getPressHandler()
      ...
      return function()
        ...
        elseif card.id == "bluejay" then
          targetPage = "setup_esc_motors_esc_tools_bluejay_page"
        elseif card.id == "flrtr" then
          targetPage = "setup_esc_motors_esc_tools_flrtr_page"
        elseif card.id == "hw5" then
          targetPage = "setup_esc_motors_esc_tools_hw5_page"
        elseif card.id == "omp" then
          targetPage = "setup_esc_motors_esc_tools_omp_page"
        elseif card.id == "scorp" then
        ...
        elseif card.id == "ztw" then
          targetPage = "setup_esc_motors_esc_tools_ztw_page"
        end
