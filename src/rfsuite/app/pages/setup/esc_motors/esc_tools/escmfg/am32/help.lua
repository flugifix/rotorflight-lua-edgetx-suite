return function(ctx)
  ...
  local fallback = "Settings held by the AM32 speed controller itself. They are read from it when "
  ...
  local message = i18n and i18n.t and i18n.t("app.pages.setup_esc_motors.help_am32") or fallback
